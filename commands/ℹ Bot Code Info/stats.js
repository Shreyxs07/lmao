...
module.exports = {
  ...
  execute: async (client, message, args) => {
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .addField(`🗓 Creation Date -`, `27 March 2022`, false)
      .addField(`Made With :`, `Javascript executor And SQ Lite DataBase And Your Love`, false)
      .addField(`:tools: Developers of This Bot -`, `Cute panda`, false)
