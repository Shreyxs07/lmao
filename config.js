...
mainprefix: "f!",
"secret": "OTU3NTM5MzkwNDk2ODYyMjI4.YkAQDA.XJ6maNN2cnIwYB3iN9nzQnomKWU",
...
defaultleavemessage: "{user} Left, Invited by {inviter}",
  basiclang: "en", //The basic language of the bot, "fr" for French and "en" for English
    ...
    auth: {
        support: "I dont have any server :C", //The link of your Discord server
